...
type ValueType = Format | undefined;
...
export const getFormatSelectWithUndefinedFormItem = (data: EditableData | ReadOnlyData, defaultValue?: Format): ReactElement<Props> => (
