...
export const friendsDataAction = {
  ...
  startReadAllBookRequests: createAction(FriendsDataActionName.START_READ_ALL_BOOK_REQUESTS)(),
  readAllBookRequestsSucceeded: createAction(FriendsDataActionName.READ_ALL_BOOK_REQUESTS_SUCCEEDED)<BookRequestWithBookData[]>(),
  readAllBookRequestsFailed: createAction(FriendsDataActionName.READ_ALL_BOOK_REQUESTS_FAILED)<string>(),
};
